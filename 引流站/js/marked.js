...
!function (e, t) {
    ...
    var o = /[&<>"']/, P = new RegExp(o.source, "g"), l = /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,
        O = new RegExp(l.source, "g"), j = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;"};
            ...
            return t.space = function (e) {
                ...
                if (t) {
                    var u, n, r, i, s, a, o, l, D, c, p, h = 1 < (g = t[1].trim()).length,
                        f = {type: "list", raw: "", ordered: h, start: h ? +g.slice(0, -1) : "", loose: !1, items: []},
    ...
    var B = function () {
            ...
            return n.lex = function (e) {
                ...
                var s, a, o, e, l, D, c = this, p = (void 0 === i && (i = []), r);
            ...
            return e.parse = function (e, t) {
                void 0 === t && (t = !0);
                for (var u, n, r, i, s, a, o, l, D, c, p, h, f, g, F, d, k = "", A = e.length, C = 0; C < A; C++) if (l = e[C], this.options.extensions && this.options.extensions.renderers && this.options.extensions.renderers[l.type] && (!1 !== (d = this.options.extensions.renderers[l.type].call({parser: this}, l)) || !["space", "hr", "heading", "code", "table", "blockquote", "list", "html", "paragraph", "text"].includes(l.type))) k += d || ""; else switch (l.type) {
                    case"space":
                        continue;
                    case"hr":
                        k += this.renderer.hr();
    ...
    function X(p, h) {
        ...
        return function (e, u, n) {
            ...
            var t, r = g({}, u), i = (u = g({}, f.defaults, r), F(f, T)[T](u.silent, u.async, n));
            ...
            try {
                ...
                var D = p(e, u), c = (u.walkTokens && f.walkTokens(D, u.walkTokens), h(D, u));
    ...
    var V = (I.parse = I).options, J = I.setOptions, K = I.use, W = I.walkTokens, Y = I.parseInline, ee = I,
        te = z.parse, ue = B.lex;
